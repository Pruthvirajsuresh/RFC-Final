...
public class User_credentail_Test extends Base {
	...
	public void seller_cred() throws InterruptedException, IOException {
		...
		User_credential_.user_credentails();
		Thread.sleep(2000);
